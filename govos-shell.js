...
(function () {
  ...
  var TENANT_REG = {
    ...
    'hi-maui':    { name: 'Maui County',               reports: [['Who governs','officials_scorecard.html'],['2026 candidates & their money','candidates_2026_maui.html'],['Money behind officials','money_behind_officials.html'],['Who funds elections (by industry)','who_funds_elections_maui.html'],['Who paid the vote','who_paid_the_vote.html'],['Money × votes','patterns_money_x_votes.html'],['Contracts × donors','contracts_x_donors.html'],['Contracts & spending','maui_contract_awards.html'],['Federal dollars','federal_money.html'],['Lobby + money','lobby_money_watch.html'],['Sole-source watch','sole_source_watch.html'],['Wildfire recovery','wildfire_recovery_watch.html'],['Real estate & development','realestate_maui.html'],['Parcel map','maui_parcel_map.html'],['Great Māhele & land','great_mahele_overlay.html'],['990 Nonprofits','nonprofits_maui.html'],['Subcontractor chain','subcontracts_maui.html'],['Council votes & dissent','council_votes_maui.html'],['Upcoming agendas','agendas_maui.html'],['Meeting minutes','minutes_hi-maui.html'],['Testimony & money','testimony_money.html'],['Sunshine Law watch','sunshine_maui.html'],['County departments','departments_maui.html'],['County code & titles','king/civic/templates/county-code/Maui%20County%20Code%20%26%20Rules.html'],['Title 19 — zoning','title19.html'],['Budget transparency','king/civic/templates/budget-transparency/Budget%20Transparency.html'],['Charter ↔ Law','crosswalk_maui.html'],['Audit balance','audit_balance.html']] },
  ...
  var PAGE_INDEX = [
    ...
    { title:'County Dashboard', desc:'Coverage map + lens activity + money trail', href:'site/county_dashboard.html', tenant:'hi-maui' },
    { title:'Charter → Law → Evidence', desc:'12 Stones Charter bound to existing enforceable law', href:'site/charter_application.html', tenant:'hi-maui' },
    { title:'Aloha ʻĀina', desc:'Food security as land vitality, 57 certified operations', href:'site/aloha_aina.html', tenant:'hi-maui' },
    { title:'Testify', desc:'How to testify at a public meeting', href:'site/testify.html', tenant:'hi-maui' },
    { title:'Open Data', desc:'Raw public records behind every dashboard', href:'site/datasets.html', tenant:'hi-maui' },
    { title:'Oversight: Maui', desc:'Public oversight questions, sourced and framed for review', href:'site/oversight_hi-maui.html', tenant:'hi-maui' },
    { title:'Oversight: Hawaii State', desc:'Public oversight questions for State of Hawaiʻi', href:'site/oversight_hi-state.html', tenant:'hi-state' },
    { title:'Wildfire Recovery Watch', desc:'Where the $22M+ Maui wildfire recovery money went', href:'site/wildfire_recovery_watch.html', tenant:'hi-maui' },
    { title:'Lobby + Money', desc:'Entities that both lobby the State and donate to officials', href:'site/lobby_money_watch.html', tenant:'hi-maui' },
    { title:'Sunshine Law Watch', desc:'HRS §92-7 meeting notice compliance', href:'site/sunshine_maui.html', tenant:'hi-maui' },
  ...
  function ensureNav() {
    ...
    el.innerHTML = [
      '<a class="gn-brand" href="site/reports.html"><span class="mk">&#10022;</span><b>govOS</b><span class="sub">Kilo Aupuni</span></a>',
      ...
      '<div class="gn-menu">',
        ...
        '<div class="gn-group">',
          ...
          '<div class="gn-panel">',
            ...
            '<a href="site/agenda_explainer.html">Agenda explainer</a>',
            '<a href="site/sage_bridge.html">Sage</a>',
            '<a href="site/olelo_glossary.html">&#699;&#332;lelo</a>',
          '</div>',
        '</div>',
        '<a class="gn-lead" href="site/testify.html">&#9878; Testify</a>',
        '<a class="gn-link" href="site/request_records.html">Request Records</a>',
