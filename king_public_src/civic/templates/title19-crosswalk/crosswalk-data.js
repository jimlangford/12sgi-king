...
(function () {
  ...
  const RULES_TO_CODE = [
    ...
    { topic: "Civil fines / enforcement procedure (cross-title 16/18/19)", code: "MCC 19.530.030", codeStatus: "ingested",
      rule: "Rule §15-2 (Title MC-15) — Admin Procedures & Civil Fines for Violations of Titles 16, 18 & 19; eff. 9/3/1993. Full fine schedule (initial+daily), 30-day finality, appeal to BVA/Board of Code Appeals, continuing-violation doubling to $1,000/day max.", ruleStatus: "ingested",
      note: "Ties civil-fine machinery to violations across Titles 16 (Buildings), 18 (Subdivisions), 19 (Zoning) — the cross-title enforcement linkage for the digital twin.",
      codifyCandidate: "A3 (now SOURCED — schedule belongs in code), C7", src: "https://www.mauicounty.gov/DocumentCenter/View/149499/Water-Supply-Rule-15-2-Violations-of-Titles-16-18-and-19-of-the-Maui-County-Code" },
    { topic: "SMA enforcement — Maui Island (Ch. 202)", code: "HRS 205A-32 (≤$100,000; ≤$10,000/day)", codeStatus: "ingested",
      rule: "Maui SMA Rules Ch. 202 §12-202-23 Enforcement / §12-202-25 Penalties — am & comp 08/25/2024: ≤$100,000/violation + ≤$10,000/day; dept imposes after ch. 91 appeal hearing; §12-202-23 now references 'notice of warning or notice of violation'.", ruleStatus: "ingested",
      note: "2024 amendment partly supersedes the 2003 CC opinion (Item 288) on BOTH amount ($10k→$100k) and the no-warning point.",
      codifyCandidate: "enforcement-corpus", src: "https://www.mauicounty.gov/DocumentCenter/View/8413/SMA-Rules-" },
