...
def main():
    ...
    html=("<!doctype html><meta charset=utf-8><meta name=viewport content='width=device-width,initial-scale=1'>"
      ...
      ".off{background:#e7eef8;border:1px solid #bacde6;border-radius:12px;padding:.7rem 1rem;margin:.7rem 0}"
      ...
      ".disc{background:#eef2f7;border:1px solid #bacde6;border-radius:10px;padding:.7rem 1rem;color:#41536b;font-size:.85rem;margin:.8rem 0}</style>"
