...
def main():
    ...
    html=("<!doctype html><meta charset=utf-8><meta name=viewport content='width=device-width,initial-scale=1'>"
      ...
      "body{font-family:'Segoe UI',system-ui,sans-serif;max-width:920px;margin:1.3rem auto;padding:0 1rem;color:#eaf2fc;background:#081420}"
      "h1{font-size:1.5rem;margin:.3rem 0}.sub{color:#9fb2c8;font-size:.9rem;line-height:1.5}"
      ".off{background:#0f2540;border:1px solid #1f3d5f;border-radius:12px;padding:.7rem 1rem;margin:.7rem 0}"
      ".oh{display:flex;align-items:center;gap:10px}.oh h2{font-size:1.05rem;margin:.2rem 0;color:#7fb2ff}"
      ".maui{font-size:10px;letter-spacing:.5px;text-transform:uppercase;font-weight:700;color:#4ec98a;background:rgba(31,138,91,.13);border-radius:99px;padding:3px 9px}"
      ".seat{font-size:.85rem;color:#6cb0f0;font-family:Consolas,monospace}.meta{font-size:.8rem;color:#8ea3ba;margin-top:3px}a{color:#6cb0f0}"
      ".disc{background:#0f2540;border:1px solid #1f3d5f;border-radius:10px;padding:.7rem 1rem;color:#9fb2c8;font-size:.85rem;margin:.8rem 0}</style>"
