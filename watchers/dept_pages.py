...
CSS = (
    "body{margin:0;background:#f4f7fb;color:#13243d;font-family:'Segoe UI',system-ui,sans-serif;line-height:1.55}"
    ".wrap{max-width:980px;margin:0 auto;padding:20px 18px 80px}"
    ".eyebrow{font-family:Consolas,'JetBrains Mono',monospace;font-size:11px;letter-spacing:1.6px;color:#00356b;text-transform:uppercase}"
    ...
    ".links a{display:inline-block;text-decoration:none;border:1px solid #bacde6;border-radius:10px;padding:9px 14px;color:#00356b;background:#fff;font-size:14px}"
    ".links a:hover{border-color:#00356b;background:#eef4fc}"
    ...
    ".kpi div{background:#fff;border:1px solid #d4e0ee;border-radius:10px;padding:12px 16px;min-width:150px}"
    ".kpi b{display:block;font-family:Consolas,'JetBrains Mono',monospace;font-size:22px;color:#00356b}"
    ".kpi span{font-size:12px;color:#5b6e86}"
    "h2{font-size:17px;margin:24px 0 6px}"
    "table{width:100%;border-collapse:collapse;margin-top:8px;font-size:13.5px;background:#fff}"
    ...
    "a.back{display:inline-block;margin:0 0 12px;color:#00356b;text-decoration:none;font-size:13px}"
    ...
    ".caps a,.caps span{display:inline-block;border:1px solid #bacde6;border-radius:10px;padding:9px 13px;font-size:13.5px;text-decoration:none;color:#00356b;background:#fff}"
    ...
    ".caps span.soon{opacity:.65;border-style:dashed;background:#f6f8fb;color:#5b6e86}"
)
