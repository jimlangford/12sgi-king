...
CSS = (
    ...
    ".links a:hover{border-color:#7fb2ff;background:#0f2540}"
    ...
    ".method{background:#0f2540;border-left:3px solid #00356b;padding:9px 13px;border-radius:0 8px 8px 0;font-size:12.5px;color:#33485f;margin:10px 0}"
