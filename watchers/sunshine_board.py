...
def build():
    ...
    body = (
        ...
        '<style>.mtg{border:1px solid #d6e2f0;border-radius:10px;padding:.7rem .9rem;margin:.7rem 0;background:#fff}'
        '.mh{font-weight:700;color:#0e4a84}.cd{font-size:.92rem;margin:.3rem 0}.fine{color:#5a6b7b;font-size:.82rem;margin:.25rem 0}'
        '.notice{white-space:pre-wrap;background:#f6f9fc;border:1px solid #e3edf6;border-radius:8px;padding:.6rem;font-size:.8rem;overflow:auto}'
