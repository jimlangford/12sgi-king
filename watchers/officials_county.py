...
def page(slug, c, gen):
    ...
    html=("<!doctype html><meta charset=utf-8><meta name=viewport content='width=device-width,initial-scale=1'>"
      ...
      ".disc{background:#0f2540;border:1px solid #1f3d5f;border-radius:10px;padding:.7rem 1rem;color:#9fb2c8;font-size:.85rem;margin:.8rem 0}"
      "table{border-collapse:collapse;width:100%%;font-size:.9rem;margin-top:.4rem}td,th{padding:.45rem .6rem;border-bottom:1px solid #1f3d5f;text-align:left}"
      ".d{font-family:Consolas,monospace;color:#6cb0f0;white-space:nowrap;width:1%%}.nm{font-weight:600;color:#7fb2ff}"
      ".role{color:#4ec98a;font-size:.82rem;font-family:Consolas,monospace}th{color:#8ea3ba;font-size:.72rem;letter-spacing:.5px;text-transform:uppercase}a{color:#6cb0f0}</style>"
      "<h1>%s — who governs</h1>"
