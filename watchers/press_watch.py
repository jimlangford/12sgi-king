...
def _html(out):
    ...
    doc = ("<!doctype html><meta charset=utf-8><meta name=viewport content='width=device-width,initial-scale=1'>"
           ...
           "h1{color:#0e4a84;font-size:1.3rem}.lead{color:#33414f}.item{border-bottom:1px solid #eef3f9;padding:.6rem 0}"
           ".t{font-weight:600}a{color:#0b6bcb;text-decoration:none}.pri{background:#fff4e5;border:1px solid #f0c98a;"
           "color:#8a5a12;border-radius:99px;padding:.05rem .55rem;font-size:.72rem;margin-left:.4rem}"
