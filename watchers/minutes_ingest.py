...
def _write_provenance_html(base):
    ...
    head=("<!doctype html><meta charset=utf-8><meta name=viewport content='width=device-width,initial-scale=1'>"
        ...
        "body{font-family:'Segoe UI',system-ui,sans-serif;max-width:960px;margin:1.3rem auto;padding:0 1rem;color:#eaf2fc;background:#081420;line-height:1.55}"
        ...
        "</style>"
        "<div class=sub style='letter-spacing:.1em;text-transform:uppercase;color:#6cb0f0;font-weight:600'>govOS &middot; kilo aupuni &middot; asked in aloha</div>"
    ...
    dyn=("<div class=sub>Generated %s.</div>"
        "<div class=kpi>%s &times;%d &nbsp;&nbsp; %s &times;%d &nbsp;&nbsp; <span style='color:#9fb2c8;font-weight:400;font-size:.85rem'>of %d records, %d with searchable text</span></div>"
