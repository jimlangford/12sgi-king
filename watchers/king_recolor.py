...
MAP=[("#0c100e","#ffffff"),("#0b0f12","#ffffff"),("#0b0f0d","#f3f7fc"),("#080c12","#ffffff"),("#0a0e14","#ffffff"),
     ...
     ("#243029","#bacde6"),("#2a2f29","#bacde6"),("#34301f","#bacde6"),("#213049","#d3d8ef"),("#25323a","#bacde6"),("#5a3a1a","#e6d8a8"),
     ...
     ("#d9622b","#b8860b"),("#e06c6c","#b4242c"),("#4a2222","#e6bcbc"),("#7f8a78","#5b6e86"),("#bcd0ea","#41536b"),("#cfe0c9","#1f5a3c"),("#8fae7e","#1f5a3c"),
