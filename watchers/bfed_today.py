...
def main():
    ...
    html=("<!doctype html><meta charset=utf-8><meta http-equiv=refresh content=300>"
     ...
     "body{font-family:system-ui,Segoe UI,sans-serif;max-width:960px;margin:2rem auto;padding:0 1.1rem;color:#15212e}"
     "a{color:#0b6bcb;text-decoration:none}h1{font-size:1.5rem;margin:.2rem 0}h2.ph{font-size:1.15rem;margin:1.6rem 0 .2rem;color:#1f6b4a}"
     ...
     ".live{display:inline-block;background:#fff4e5;border:1px solid #f0c98a;color:#8a5a12;border-radius:99px;padding:.15rem .7rem;font-size:.78rem;font-weight:600}"
     ...
     ".pono{border-left:3px solid #1f9d55;background:#f3faf5;border-radius:0 10px 10px 0;padding:.7rem 1rem;margin:.6rem 0}"
     ".qi{font-weight:650;font-size:.92rem;color:#15212e;margin-bottom:.3rem}.q{color:#2c4a3a;font-size:.92rem;line-height:1.5}.sub2{font-size:.82rem}</style>"
