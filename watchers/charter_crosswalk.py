...
Model (generalizes the Maui-only charter_law_map.py to every tenant):
  ...
  COLS  = the law bodies in this tenant's hierarchy, bottom to apex:
            local (this tenant's charter + code/ordinances)  -> the VARIABLE layer,
            state -> United States -> International -> ICC -> ICJ -> Holy See  -> the SHARED SPINE
...
This is a roadmap of lawful CORRESPONDENCE — "the law that already exists to reach the same
end" — framed as a question/map, never an accusation against any person. Integrity rule:
no fabricated citation ships; an uncertain section number is softened to the instrument name
+ a pending tag, so the adversarial verifier (fan-out phase) can tighten it.

Stdlib only. No subprocess -> no console popup. Output: reports/mauios/crosswalk_<id>.html
"""
import os, html
...
# ── the SHARED APEX SPINE — flagship instruments every tenant answers up to ─────────────────
# (v = verified flagship citation I'm confident is real + accurately described;
#  p = instrument named, exact section pending verification by the fan-out verifier.)
def C(layer, cite, note, conf="v"):
    return {"layer": layer, "cite": cite, "note": note, "conf": conf}

# ── governance FUNCTIONS (rows). Each = one SSC article -> the ladder of real law. ───────────
# `local` is filled per-tenant from TENANTS[...]["local"][key]; the rest is the shared spine.
FUNCTIONS = [
    {
        "key": "transparency",
        "title": "Transparency — every public dollar posted & traceable",
        ...
        "spine": [
            C("United States", "5 U.S.C. §552 — Freedom of Information Act",
              "Federal public right of access to agency records."),
            C("International", "UN Convention against Corruption (UNCAC, 2003), Art. 10 & 13",
              "Public reporting and access to information on public administration."),
            C("Holy See", "Code of Canon Law (1983), c. 1287 §2",
              "Administrators of ecclesiastical goods must render a public account of offerings to the faithful."),
        ],
    },
    {
        "key": "conflict",
        "title": "Conflict of interest — no private funder steers a public decision",
        ...
        "spine": [
            C("United States", "18 U.S.C. §208 — Acts affecting a personal financial interest",
              "Criminal conflict-of-interest bar on federal officials."),
            C("International", "UNCAC (2003), Art. 7(4) & 8",
              "Systems to prevent conflicts of interest; codes of conduct for public officials."),
            C("Holy See", "Code of Canon Law (1983), c. 1298",
              "Caution against alienation of Church goods to administrators or their relatives.", "p"),
        ],
    },
    {
        "key": "sunshine",
        "title": "Open meetings & the people's voice in every decision",
        ...
        "spine": [
            C("United States", "Government in the Sunshine Act — 5 U.S.C. §552b",
              "Open-meeting requirement for federal multi-member agencies."),
            C("International", "ICCPR (1966), Art. 25; UDHR Art. 21",
              "Right to take part in the conduct of public affairs."),
            C("Holy See", "Code of Canon Law (1983), c. 212 §3",
              "The faithful have the right to make their views on the good of the Church known."),
        ],
    },
    {
        "key": "fiduciary",
        "title": "Public-trust stewardship of land, water & resources",
        ...
        "spine": [
            C("United States", "Public-trust doctrine — PPL Montana, LLC v. Montana, 565 U.S. 576 (2012)",
              "Sovereign holds navigable waters/beds in trust for the public."),
            C("International", "Rio Declaration (1992), Principles 1–4; UN SDGs (2015)",
              "Sustainable stewardship for present and future generations."),
            C("Holy See", "Laudato Si' (2015) encyclical; Code of Canon Law c. 1254",
              "Care for the common home; Church goods held for sacred and just purposes."),
        ],
    },
    {
        "key": "sacred",
        "title": "Sacred sites & burial grounds — protected, repatriated",
        ...
        "spine": [
            C("United States", "NAGPRA, 25 U.S.C. §3001 et seq.; NHPA, 54 U.S.C. §300101",
              "Repatriation of remains; protection of historic & cultural properties."),
            C("International", "UN Declaration on the Rights of Indigenous Peoples (UNDRIP, 2007), Arts. 11–12",
              "Rights to cultural/spiritual sites and to repatriation of remains."),
            C("Holy See", "Code of Canon Law (1983), cc. 1205–1213",
              "Sacred places: their dedication, protection, and the loss of that character only by decree."),
        ],
    },
    {
        "key": "enforcement",
        "title": "Enforcement, remedy & tribunals",
        ...
        "spine": [
            C("United States", "42 U.S.C. §1983 (deprivation of rights); §1985 (conspiracy)",
              "Civil action against officials who deprive rights under color of law — cited in the Charter itself."),
            C("International", "ICCPR (1966), Art. 2(3)",
              "Right to an effective remedy for violations."),
            C("ICC", "Rome Statute (2002), Arts. 5 & 17",
              "Jurisdiction over the gravest crimes; complementarity to national courts."),
            C("ICJ", "Statute of the International Court of Justice, Art. 36",
              "Jurisdiction over legal disputes between states."),
            C("Holy See", "Code of Canon Law (1983), Book VII (Processes), cc. 1400+; c. 1311",
              "The Church's own forum and its inherent right to penal coercion."),
        ],
    },
    {
        "key": "culture",
        "title": "Cultural & lineage integrity — language, education, ʻāina",
        "ssc": ("Art. V — Cultural and Lineage Integrity",
                "Hawaiian language, lineage, and cultural transmission are protected as the living spine of governance."),
        "spine": [
            C("United States", "Native American Languages Act, 25 U.S.C. §2901; Apology Resolution, Pub. L. 103-150 (1993)",
              "Federal policy to preserve Native languages; acknowledgment of the 1893 overthrow."),
            C("International", "UNDRIP (2007), Arts. 13–14; ICESCR Art. 15",
              "Rights to language, culturally appropriate education, and cultural life."),
            C("Holy See", "Vatican II, Sacrosanctum Concilium (1963) — inculturation/vernacular",
              "Magisterial principle of honoring a people's language and culture.", "p"),
        ],
    },
    {
        "key": "selfdet",
        "title": "Foundation & self-determination of the people",
        ...
        "spine": [
            C("United States", "Apology Resolution, Pub. L. 103-150 (1993)",
              "Congress acknowledges the illegal overthrow of the Kingdom of Hawaiʻi and the unrelinquished claims of Native Hawaiians."),
            C("International", "UN Charter Art. 1(2); ICCPR/ICESCR common Art. 1; UNGA Res. 1514 (1960)",
              "Self-determination of peoples as a foundational principle of international law."),
            C("ICJ", "Western Sahara, Advisory Opinion (1975); Chagos, Advisory Opinion (2019)",
              "Self-determination affirmed as an erga omnes obligation."),
            C("Holy See", "Pacem in Terris (1963) encyclical",
              "The rights of peoples and nations to existence and self-development.", "p"),
        ],
    },
]

# ── TENANTS — the VARIABLE local layer + the state corpus each one inherits. ────────────────
# State of Hawaiʻi is the proof tenant (it IS the parent corpus, so local == state).
TENANTS = {
    "state": {
        "id": "HI-000", "name": "State of Hawaiʻi", "seat": "Honolulu",
        ...
        "local": {
            "transparency": C("State of Hawaiʻi", "HRS Ch. 92F (UIPA); HRS Ch. 11, Pt. XIII (Campaign Finance)",
                              "Open-records right + every campaign contribution made public record via the Campaign Spending Commission."),
            "conflict":     C("State of Hawaiʻi", "HRS Ch. 84 — State Ethics Code (Standards of Conduct)",
                              "Conflict-of-interest disclosure and recusal; enforced by the State Ethics Commission."),
            "sunshine":     C("State of Hawaiʻi", "HRS Ch. 92 — Sunshine Law (open meetings)",
                              "Public's right to open meetings and to testify before any board acts."),
            "fiduciary":    C("State of Hawaiʻi", "Haw. Const. Art. XI §1 (public trust); Public Land Trust, HRS Ch. 171",
                              "Natural resources held in trust for the benefit of the people."),
            "sacred":       C("State of Hawaiʻi", "HRS Ch. 6E — Historic Preservation; §6E-43 (burial sites) + Island Burial Councils",
                              "State protection of burial sites and historic/cultural properties."),
            "enforcement":  C("State of Hawaiʻi", "Haw. Const. Art. VI (Judiciary); HRS Title 32 (Courts)",
                              "The state forum for remedy and adjudication."),
            "culture":      C("State of Hawaiʻi", "Haw. Const. Art. XV §4 (Hawaiian + English official); Art. X §4 (Hawaiian education); Art. XII (OHA / Hawaiian Affairs)",
                              "Hawaiian as an official language; constitutional Hawaiian-education and Hawaiian-affairs mandates."),
            "selfdet":      C("State of Hawaiʻi", "Haw. Const. Preamble & Art. XII; 1978 Con-Con Hawaiian provisions",
                              "Constitutional recognition of Native Hawaiian rights and trust obligations."),
        },
    },
}

CONF_TAG = {"v": '<span class="cf v">cited</span>',
            "p": '<span class="cf p">§ pending verification</span>'}

def cell(c):
    return ('<div class="cell %s"><div class="cl">%s</div>'
            '<div class="ci">%s %s</div><div class="cn">%s</div></div>') % (
        "pend" if c["conf"] == "p" else "",
        esc(c["layer"]), esc(c["cite"]), CONF_TAG[c["conf"]], esc(c["note"]))

def row_card(fn, t):
    art, text = fn["ssc"]
    layers = []
    loc = t["local"].get(fn["key"])
    if loc: layers.append(loc)
    layers.extend(fn["spine"])
    cells = "".join(cell(c) for c in layers)
  ...
  <div class="ssc"><span class="ssc-k">12 Stones Sovereign Charter &middot; %s</span>
    <span class="ssc-x">&ldquo;%s&rdquo;</span></div>
  <div class="cells">%s</div>
</div>""" % (esc(fn["title"]), len(layers), (" &middot; %d pending" % npend) if npend else "",
             esc(art), esc(text), cells)

def build(tid):
    t = TENANTS[tid]
    g = now_hst().strftime("%Y-%m-%d %H:%M HST")
    cards = "".join(row_card(fn, t) for fn in FUNCTIONS)
    tot_cells = sum(1 + len(fn["spine"]) for fn in FUNCTIONS)
    pend = sum(1 for fn in FUNCTIONS for c in ([t["local"].get(fn["key"])] + fn["spine"]) if c and c["conf"] == "p")
    return """<!DOCTYPE html>
...
<div class="eyebrow">12 Stones Global &middot; Kilo Aupuni &middot; %s &middot; %s</div>
...
<div class="spine">Hierarchy &middot; <b>%s</b> &rarr; <b>United States</b> &rarr; <b>International</b> &rarr; <b>ICC</b> &rarr; <b>ICJ</b> &rarr; <b>Holy See</b></div>
...
<footer>generated %s &middot; charter-crosswalk v1 &middot; SSC v5 &times; %s &middot; sources: HRS, U.S. Code, UN/UNCAC/ICCPR, Rome &amp; ICJ Statutes, Code of Canon Law (1983) &middot; Kilo Aupuni &middot; aloha &middot; pono</footer>
</div></body></html>""" % (
        esc(t["name"]), esc(t["id"]), esc("seat: " + t["seat"]),
        esc(t["name"]), esc(t["local_label"]),
        tot_cells, len(FUNCTIONS), pend, cards, g, esc(t["name"]))
...
def main():
    ...
    for tid in TENANTS:
        ...
        built.append((tid, out))
        t = TENANTS[tid]
        nc = sum(1 + len(fn["spine"]) for fn in FUNCTIONS)
        np = sum(1 for fn in FUNCTIONS for c in ([t["local"].get(fn["key"])] + fn["spine"]) if c and c["conf"] == "p")
        print("crosswalk_%s.html  %s  %d functions  %d cells  %d pending" % (tid, t["name"], len(FUNCTIONS), nc, np))
    return 0
