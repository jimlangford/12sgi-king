...
def page(events,gen,mr,ao_po):
    ...
    sup=("<style>.dv{border:1px solid var(--line);border-left:3px solid #b4242c;border-radius:11px;padding:.7rem 1rem;margin:.6rem 0;background:var(--panel)}"
         ...
         ".dv .spl{margin:.4rem 0;font-size:.92rem}.dv .no{display:inline-block;background:#2a1416;color:#f0b0b0;border:1px solid #6a3030;border-radius:99px;padding:.12rem .55rem;margin:.1rem .25rem .1rem 0;font-size:.82rem;font-weight:600}"
         ...
         ".dv .qt{background:#241d0e;border:1px solid #5c4a1e;border-radius:8px;padding:.4rem .7rem;margin:.35rem 0;font-size:.88rem;color:#e3c98a;line-height:1.5}"
         ...
         ".mn{color:var(--ink);font-weight:600}.mc{font-family:Consolas,monospace;color:#f0b0b0;font-size:.82rem;white-space:nowrap}"
