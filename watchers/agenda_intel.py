...
def _html(out):
    ...
    doc = ("<!doctype html><meta charset=utf-8><meta name=viewport content='width=device-width,initial-scale=1'>"
           ...
           "h1{color:#0e4a84;font-size:1.3rem}.lead{color:#33414f}.mtg{border:1px solid #d6e2f0;border-radius:10px;padding:.6rem .9rem;margin:.7rem 0}"
           ".mh{color:#0e4a84;margin-bottom:.3rem}.item{border-top:1px solid #eef3f9;padding:.45rem 0}.t{font-weight:600}"
