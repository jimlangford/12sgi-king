...
def controls_css():
    return ("<style>"
            ...
            "color:var(--ink,#13243d);background:#fff;border:1px solid var(--line,#bacde6);border-radius:9px;padding:.45rem .7rem}"
            ...
            "border:1px solid var(--line,#bacde6);background:#fff;color:var(--accent,#00356b);"
