...
.bars{margin:.6rem 0 1rem}.bar{display:grid;grid-template-columns:250px 1fr 96px;gap:10px;align-items:center;margin:.42rem 0;font-size:.88rem}.bar .bn{color:var(--ink);line-height:1.22;overflow:hidden}.bar .bn .nL{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.bar .bn .sL{display:block;font-size:.72rem;color:var(--faint)}.bar .bn .sL .re{color:var(--ask)}.bar .bn .sL .rcz{color:#f0b0b0}.bar .bt{background:#dae5f3;border-radius:99px;height:14px;overflow:hidden}.bar .bt i{display:block;height:14px;border-radius:99px;background:linear-gradient(90deg,#00356b,#1259a3)}.bar .bt i.warm{background:linear-gradient(90deg,#b8860b,#d9a93a)}.bar .bv{font-family:Consolas,monospace;font-weight:700;color:var(--accent);text-align:right}@media(max-width:560px){.bar{grid-template-columns:140px 1fr 78px}}
