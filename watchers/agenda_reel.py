...
def write_index(built):
    ...
    html = (
        ...
        "body{margin:0;background:#fff;color:#13243d;font-family:Georgia,serif;padding:28px}"
        "h1{font-size:26px;margin:0 0 4px} .lead{color:#41536b;font-size:14px;max-width:80ch}"
        ".banner{background:#fff6e8;border:1px solid #e0c080;border-radius:10px;padding:12px 16px;margin:16px 0;font-size:13px;color:#7a5a10}"
        ".grid{display:flex;flex-wrap:wrap;gap:22px;margin-top:18px}"
        ".card{width:300px;border:1px solid #bacde6;border-radius:14px;overflow:hidden;background:#f7fafe}"
        "video{width:300px;height:533px;object-fit:cover;background:#000;display:block}"
        ".meta{padding:12px 14px} .t{font-weight:700} .d{font-size:12px;color:#6d7f97;font-family:Consolas,monospace}"
        ".yt{font-size:13px;margin:8px 0;color:#13243d} .tags{font-family:Consolas,monospace;font-size:11px;color:#00356b;margin-bottom:8px}"
        "a{color:#1259a3;font-family:Consolas,monospace;font-size:11px}"
        "footer{margin-top:26px;border-top:1px solid #bacde6;padding-top:12px;color:#6d7f97;font-family:Consolas,monospace;font-size:11px}"
        "</style></head><body>"
