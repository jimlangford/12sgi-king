...
def build(tenant="hi-maui"):
    ...
    body = (
        ...
        '<h1 style="color:#7fb2ff">Build Our Government Software</h1>'
        ...
        + signup +
        '<h2 style="color:#7fb2ff;margin-top:1.2rem">Membership</h2>'
        ...
        + _tier_ladder_html() +
        '<h2 style="color:#7fb2ff;margin-top:1.3rem">The board</h2>'
